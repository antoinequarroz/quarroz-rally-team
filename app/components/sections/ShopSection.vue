...
<template>
  <section class="section-shell section-padding">
    <div class="section-container relative z-10">
      <p class="eyebrow-hero">005 // Shop</p>
      <h2 class="section-title-hero mt-3">Boutique supporter MVP.</h2>
      ...
      <div class="mt-10 grid gap-5 md:grid-cols-3">
        <article v-for="product in products" :key="product.id" class="section-card flex flex-col overflow-hidden">
          <div class="grid aspect-[4/3] place-items-center bg-[linear-gradient(135deg,#0d0f14,#e11d2e_70%)] p-6 text-center text-white">
          ...
          <div class="flex flex-1 flex-col p-5">
            ...
            <p class="mt-3 text-sm leading-6 text-white/65">{{ product.description }}</p>
